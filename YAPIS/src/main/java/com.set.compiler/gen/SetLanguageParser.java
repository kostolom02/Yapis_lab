package com.set.compiler.gen;// Generated from SetLanguage.g4 by ANTLR 4.7.2
...
public class SetLanguageParser extends Parser {
	...
	public static final int
		...
		RULE_initialize_set = 4, RULE_initialize_element = 5, RULE_assign_var_method_invocation = 6,
		RULE_assign_set = 7, RULE_assign_var = 8, RULE_print = 9, RULE_operations = 10, 
		RULE_operations_with_set = 11, RULE_simple_compare = 12, RULE_hard_compare = 13,
		RULE_while_cycle = 14, RULE_if_then = 15, RULE_for_each = 16, RULE_global_assign_set = 17,
		...
		RULE_block_non_return = 25, RULE_signature_method_invocation = 26, RULE_method_invocation = 27,
		RULE_global_program = 28;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "block", "statement", "digit_expression", "initialize_set",
			"initialize_element", "assign_var_method_invocation", "assign_set", "assign_var",
			"print", "operations", "operations_with_set", "simple_compare", "hard_compare",
			"while_cycle", "if_then", "for_each", "global_assign_set", "global_assign_var",
			"type", "type_1", "signature", "subprogram_return", "subprogram_non_return", 
			"block_return", "block_non_return", "signature_method_invocation", "method_invocation",
			"global_program"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'main_program'", "','", "'='", "'sub_program'", "'{'", "'set'",
			"'element'", "'add'", "'remove'", "'}'", "'print'", "'int'", "'while'",
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public Operations_with_setContext operations_with_set() {
			return getRuleContext(Operations_with_setContext.class,0);
		}
	...
	public static class Digit_expressionContext extends ParserRuleContext {
		...
		public TerminalNode MULTIPLY() { return getToken(SetLanguageParser.MULTIPLY, 0); }
		public TerminalNode DIVIDE() { return getToken(SetLanguageParser.DIVIDE, 0); }
		public TerminalNode PLUS() { return getToken(SetLanguageParser.PLUS, 0); }
		public TerminalNode MINUS() { return getToken(SetLanguageParser.MINUS, 0); }
	...
	public static class Initialize_setContext extends ParserRuleContext {
		...
		public TerminalNode PLUS() { return getToken(SetLanguageParser.PLUS, 0); }
		public TerminalNode MINUS() { return getToken(SetLanguageParser.MINUS, 0); }
		public Initialize_setContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_initialize_set; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterInitialize_set(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitInitialize_set(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitInitialize_set(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Initialize_setContext initialize_set() throws RecognitionException {
		Initialize_setContext _localctx = new Initialize_setContext(_ctx, getState());
		enterRule(_localctx, 8, RULE_initialize_set);
		int _la;
		try {
			int _alt;
			setState(117);
	...
	public static class Initialize_elementContext extends ParserRuleContext {
		public TerminalNode STRING() { return getToken(SetLanguageParser.STRING, 0); }
		public Initialize_elementContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_initialize_element; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterInitialize_element(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitInitialize_element(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitInitialize_element(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Initialize_elementContext initialize_element() throws RecognitionException {
		Initialize_elementContext _localctx = new Initialize_elementContext(_ctx, getState());
		enterRule(_localctx, 10, RULE_initialize_element);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(119);
	...
	public static class Assign_setContext extends ParserRuleContext {
		...
		public Initialize_setContext initialize_set() {
			return getRuleContext(Initialize_setContext.class,0);
		}
		public TerminalNode CONST() { return getToken(SetLanguageParser.CONST, 0); }
	...
	public static class Assign_varContext extends ParserRuleContext {
		...
		public Initialize_elementContext initialize_element() {
			return getRuleContext(Initialize_elementContext.class,0);
		}
		public TerminalNode CONST() { return getToken(SetLanguageParser.CONST, 0); }
	...
	public static class Operations_with_setContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(SetLanguageParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(SetLanguageParser.ID, i);
		}
		...
		public TerminalNode O_BRACKET() { return getToken(SetLanguageParser.O_BRACKET, 0); }
		public TerminalNode C_BRACKET() { return getToken(SetLanguageParser.C_BRACKET, 0); }
		public Operations_with_setContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_operations_with_set; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterOperations_with_set(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitOperations_with_set(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitOperations_with_set(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Operations_with_setContext operations_with_set() throws RecognitionException {
		Operations_with_setContext _localctx = new Operations_with_setContext(_ctx, getState());
		enterRule(_localctx, 22, RULE_operations_with_set);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class While_cycleContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterWhile_cycle(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitWhile_cycle(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitWhile_cycle(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Signature_method_invocationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterSignature_method_invocation(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitSignature_method_invocation(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitSignature_method_invocation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Signature_method_invocationContext signature_method_invocation() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_signature_method_invocation);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class Method_invocationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).enterMethod_invocation(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SetLanguageListener ) ((SetLanguageListener)listener).exitMethod_invocation(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SetLanguageVisitor ) return ((SetLanguageVisitor<? extends T>)visitor).visitMethod_invocation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Method_invocationContext method_invocation() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_method_invocation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(290);
